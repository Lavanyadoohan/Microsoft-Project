...
class Face_emotion_detection():
    def main():
        # capture the video from default camera
        webcam_video_stream = cv2.VideoCapture(0)

        # load the model and load the weights
        face_exp_model = model_from_json(open("C:/Users/Lavanya/Microsoft-project-/Face_Recogintion/dataset/facial_expression_model_structure.json", "r", encoding="utf-8").read())
        face_exp_model.load_weights('C:/Users/Lavanya/Microsoft-project-/Face_Recogintion/dataset/facial_expression_model_weights.h5')
